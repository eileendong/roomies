...
import { Moon, Sun, Monitor, Edit2, Save, X, LogOut } from "lucide-react";
    ...
    const loadProfile = async () => {
      try {
        ...
        if (profiles && profiles.length > 0) {
          ...
          const loadedProfile = {
            name: dbProfile.name || "You",
            email: dbProfile.email || "",
            phone: dbProfile.phone || "",
            avatar: dbProfile.avatar || undefined,
            notificationsEnabled: dbProfile.notificationsEnabled ?? true,
            reminderDaysBefore: dbProfile.reminderDaysBefore ?? 3,
          };
    ...
    try {
      if (profileId) {
        ...
        await client.models.UserProfile.update({
          ...
          reminderDaysBefore: editedProfile.reminderDaysBefore,
        });
      } else {
        // Create new profile
